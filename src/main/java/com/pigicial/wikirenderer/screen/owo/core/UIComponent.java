...
public interface UIComponent extends PositionedRectangle {
     ...
     * to {@link #y()} as they don't have special logic.
     */
    default int baseY() {
        return this.y();
    }
     ...
     * @see OwoUIGraphics#drawInspector(OwoUIGraphics, ParentUIComponent, double, double, boolean)
     */
