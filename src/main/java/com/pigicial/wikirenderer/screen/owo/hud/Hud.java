...
public class Hud {
     ...
     * must be explicitly positioned via either {@link com.pigicial.wikirenderer.screen.owo.core.Positioning#absolute(int, int)}
     * or {@link com.pigicial.wikirenderer.screen.owo.core.Positioning#relative(int, int)}
     *
