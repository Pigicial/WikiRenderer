...
public class ScrollContainer<C extends UIComponent> extends WrappingParentUIComponent<C> {
    ...
    public static final Identifier VERTICAL_VANILLA_SCROLLBAR_TEXTURE = Identifier.fromNamespaceAndPath(WikiRenderer.MOD_ID, "scrollbar/vanilla_vertical");
    public static final Identifier DISABLED_VERTICAL_VANILLA_SCROLLBAR_TEXTURE = Identifier.fromNamespaceAndPath(WikiRenderer.MOD_ID, "scrollbar/vanilla_vertical_disabled");
    public static final Identifier HORIZONTAL_VANILLA_SCROLLBAR_TEXTURE = Identifier.fromNamespaceAndPath(WikiRenderer.MOD_ID, "scrollbar/vanilla_horizontal_disabled");
    public static final Identifier DISABLED_HORIZONTAL_VANILLA_SCROLLBAR_TEXTURE = Identifier.fromNamespaceAndPath(WikiRenderer.MOD_ID, "scrollbar/vanilla_horizontal_disabled");
    public static final Identifier VANILLA_SCROLLBAR_TRACK_TEXTURE = Identifier.fromNamespaceAndPath(WikiRenderer.MOD_ID, "scrollbar/track");
    public static final Identifier FLAT_VANILLA_SCROLLBAR_TEXTURE = Identifier.fromNamespaceAndPath(WikiRenderer.MOD_ID, "scrollbar/vanilla_flat");
